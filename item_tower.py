...
class ItemModel(tf.keras.Model):
  ...
  def __init__(self, dataset, embedding_dim=64):
    ...
    self.category.add(layers.Embedding(self.category_vocab.vocabulary_size(), self.embedding_dim))

    self.type1_embedding = models.Sequential()
    self.type1_embedding.add(self.parent1_vocab)
    self.type1_embedding.add(layers.Embedding(self.parent1_vocab.vocabulary_size(), self.embedding_dim))

    self.type2_embedding = models.Sequential()
    self.type2_embedding.add(self.parent2_vocab)
    self.type2_embedding.add(layers.Embedding(self.parent2_vocab.vocabulary_size(), self.embedding_dim))

    self.type3_embedding = models.Sequential()
    self.type3_embedding.add(self.parent3_vocab)
    self.type3_embedding.add(layers.Embedding(self.parent3_vocab.vocabulary_size(), self.embedding_dim))

    self.type4_embedding = models.Sequential()
    self.type4_embedding.add(self.parent4_vocab)
    self.type4_embedding.add(layers.Embedding(self.parent4_vocab.vocabulary_size(), self.embedding_dim))

    self.type5_embedding = models.Sequential()
    self.type5_embedding.add(self.parent5_vocab)
    self.type5_embedding.add(layers.Embedding(self.parent5_vocab.vocabulary_size(), self.embedding_dim))
    ...
    self.property1_embedding.add(layers.Embedding(self.product_property1_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property2_embedding.add(layers.Embedding(self.product_property2_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property3_embedding.add(layers.Embedding(self.product_property3_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property5_embedding.add(layers.Embedding(self.product_property5_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property6_embedding.add(layers.Embedding(self.product_property6_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property9_embedding.add(layers.Embedding(self.product_property9_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property10_embedding.add(layers.Embedding(self.product_property10_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
    ...
    self.property11_embedding.add(layers.Embedding(self.product_property11_vocab.vocabulary_size(), self.embedding_dim, mask_zero=True))
