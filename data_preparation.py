...
def load_processed_data():
    ...
    popularity_user = pd.read_csv("processed_data/popularity_user.csv")
    ...
    num_cols = interactions_train.columns[4:15]
    ...
    popularity_user['visitorid'] = popularity_user['visitorid'].astype(str)
    return interactions_train, interactions_valid, product_features, popularity_item, popularity_user
